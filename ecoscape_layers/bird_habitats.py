...
def generate_habitats(species_list_path, terrain_path, output_folder, terrain_codes_path=None,
                        crs=None, resolution=None, resampling="near", bounds=None, padding=200000,
                        refine_method="forest_add308", species_range_folder=None):
    """
    ...
    :param resolution: desired resolution in the units of the chosen CRS, or None to use the current resolution of the input terrain raster.
